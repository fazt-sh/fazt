...
export function Datamap() {
  ...
  useEffect(() => {
    ...
    const dataMap = new window.Datamap({
      ...
      responsive: true,
      fills: {
        defaultFill: isDark ? '#374151' : '#d1d5db',
        LOW: isDark ? '#6b7280' : '#9ca3af',
        MEDIUM: isDark ? '#3b82f6' : '#60a5fa',
        MAJOR: isDark ? '#1e40af' : '#3b82f6'
      },
      data: dataSet,
      geographyConfig: {
        borderColor: isDark ? 'rgba(55, 65, 81, 0.5)' : 'rgba(0, 0, 0, 0.09)',
        borderWidth: 0.5,
